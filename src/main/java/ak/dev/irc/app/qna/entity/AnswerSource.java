...
@Table(
        name = "answer_sources",
        indexes = @Index(name = "idx_asource_answer", columnList = "answer_id")
)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class AnswerSource extends BaseAuditEntity {
    ...
    @JoinColumn(name = "answer_id", nullable = false,
            foreignKey = @ForeignKey(name = "fk_asource_answer"))
    ...
    /** Display title / label e.g. "Sahih Bukhari, Hadith 1395" */
