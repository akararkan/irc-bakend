...
/**
 * Global reels feed, bucketed per UTC day so partitions stay bounded.
 * A "discover" client iterates day buckets backwards from today.
 */
@Table("reels_by_day")
@Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
public class ReelsByDayEntity {

    @PrimaryKeyColumn(name = "day_bucket", type = PrimaryKeyType.PARTITIONED)
    private String dayBucket;        // 'YYYY-MM-DD' UTC
