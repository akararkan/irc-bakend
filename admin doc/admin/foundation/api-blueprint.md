...
| POST | `/api/v1/admin/users/{userId}/email/verify` | — | 204 | **[EXISTS]** (built 2026-08) — support override for `email_verified_at`; since 2026-08-11 users also clear it themselves via `POST /api/v1/security/email/verify` | medium / yes | `ADMIN_EMAIL_VERIFY` |
