...
[search-feed-trending.md](../platform/search-feed-trending.md). This is its canonical admin doc.

> [search-feed-trending.md](../platform/search-feed-trending.md) §2.4 keeps the PYMK **health
...
|----------|--------------------|
| PYMK algorithm knob registry (the 6 sources, ~12 weight constants) | ES relevance search → [search-feed-trending.md](../platform/search-feed-trending.md) |
| PYMK health: source mix, dismissal rate, recompute ops | Home-feed ranking → [search-feed-trending.md](../platform/search-feed-trending.md) §2.3 |
| **Contact-sync privacy**: hashing, upload caps, identity-hash backfill, consent | The follow/block social graph → [users-roles.md](directory-and-roles.md) |
| **Discoverability flags** (username/phone/email) + the QR-discovery tokens | Report triage / strikes → [safety-reports.md](../trust-safety/safety-reports.md) |
| Discovery-driven abuse (scraping, contact-harvesting, enumeration) | Consent *storage* mechanics → [logs-audit.md](../platform/logs-audit.md) §3.5 |
...
(`ConsentEvent`, append-only) — see [logs-audit.md](../platform/logs-audit.md) §3.5 and
[safety-reports.md](../trust-safety/safety-reports.md). The admin's contact-sync view must join
...
### 5.1 Tab "PYMK health" **[PLANNED]** (mirrors [search-feed-trending.md](../platform/search-feed-trending.md) §2.4)
...
(read-only, feeding [safety-reports.md](../trust-safety/safety-reports.md)):
...
([operations.md](../platform/operations.md) §6), because the fail-open window is exactly when
...
platform doesn't have, [operations.md](../platform/operations.md) §7); no reverse "who has *me* in
